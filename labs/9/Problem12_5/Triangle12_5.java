...
public class Triangle12_5 extends GeometricObject12_5 {
   ...
   */
  public Triangle12_5(String color, boolean filled) {
    super(color, filled);
  }
   ...
   * @throws IllegalTriangleException If the sum of any who sides is greater than the other side
   * then this is thrown
   */
  public Triangle12_5(double side1, double side2, double side3) throws IllegalTriangleException {
   ...
   */
  public Triangle12_5(double side1, double side2, double side3, String color, boolean filled) {
    super(color, filled);
    this.side1 = side1;
    this.side2 = side2;
    this.side3 = side3;
